    ...
    <div className="App">
      ...
      <main data-testid="main-content">
        <section className="mx-auto max-w-3xl px-4 pt-10 pb-10 sm:px-6 sm:pt-14 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-xl text-[15px] leading-relaxed text-ink-700 text-center">
        ...
        <section id="test" className="mx-auto max-w-3xl px-4 pt-2 pb-10 sm:px-6 lg:px-8">
          ...
          {stage === "done" && finalScore !== null && (
            <section id="result" className="mt-8 text-center">
              <h2 className="text-2xl font-semibold mb-2">Your AO3 Rice Purity Score</h2>
              <div className="text-5xl font-bold mb-4">{finalScore}</div>
              <p className="mb-4 text-lg">{getScoreMeaning(finalScore)}</p>
              <button
