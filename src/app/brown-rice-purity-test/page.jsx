    ...
    <div className="App">
      ...
      <main data-testid="main-content">
        ...
        <section className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8 rpt-prose">
          ...
          <p className="mt-4 text-[16px] leading-relaxed text-neutral-700 sm:text-base">
            For a more specific look at household traditions, food habits, and growing up in an Asian family, the <a href="https://ricepuritytestme.com/true-asian-rice-purity-test" className="rpt-interlink">True Asian Rice Purity Test</a> explores those shared experiences.
          </p>
